...
1. **Class Diagram** - Shows the type structure, relationships between handlers, request types, response types, and chain links
...
- [Chain of Responsibility Overview](https://vadikko2.github.io/python-cqrs-mkdocs/chain_of_responsibility/index.md) - Learn about the Chain of Responsibility pattern implementation
- [Chain of Responsibility Examples](https://vadikko2.github.io/python-cqrs-mkdocs/chain_of_responsibility/examples/index.md) - Complete examples
- [Chain of Responsibility Advanced Topics](https://vadikko2.github.io/python-cqrs-mkdocs/chain_of_responsibility/advanced/index.md) - Advanced usage patterns
