...
- **Serialization Formats** — JSON support (Protobuf support available, see [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md))
- **Type Safety** — Full Pydantic v2 support for event payloads
- **Error Handling** — Built-in retry and error handling

Prerequisites

Understanding of [Event Handling](https://vadikko2.github.io/python-cqrs-mkdocs/event_handler/index.md) and [Bootstrap](https://vadikko2.github.io/python-cqrs-mkdocs/bootstrap/index.md) is required. Events are automatically published when command handlers emit them.
...
- [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md) — For Protobuf serialization
- [Transaction Outbox](https://vadikko2.github.io/python-cqrs-mkdocs/outbox/index.md) — For reliable event delivery
...
For Protobuf event producing, see the [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md) documentation.
...
- **Protobuf** — See [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md) for Protobuf serialization
...
For Protobuf serialization, see the [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md) documentation.
