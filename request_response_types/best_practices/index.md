...
1. **Need Validation?**
1. ✅ Yes → Choose between **Pydantic** (rich features) or **Msgspec** (high performance)
1. ❌ No → Continue to step 2
1. **Need Performance?**
1. ✅ Yes → Choose **Msgspec** (fastest) or **Dataclasses** (fast & lightweight)
1. ❌ No → Continue to step 3
1. **Need Lightweight?**
1. ✅ Yes → Choose **Dataclasses** (simple) or **NamedTuple** (immutable)
1. ❌ No → Continue to step 4
1. **Need Flexibility?**
1. ✅ Yes → Choose **Standard Classes** (full control) or **Attrs** (advanced features)
1. ❌ No → Use **Dataclasses** (default choice)
...
- [Comparison Table](https://vadikko2.github.io/python-cqrs-mkdocs/request_response_types/#comparison-table) - Detailed comparison
- [Mixed Usage](https://vadikko2.github.io/python-cqrs-mkdocs/request_response_types/mixed_usage/index.md) - Combining different types
- [Request Handlers](https://vadikko2.github.io/python-cqrs-mkdocs/request_handler/index.md) - Handler implementation
