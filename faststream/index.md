...
Understanding of [Event Handling](https://vadikko2.github.io/python-cqrs-mkdocs/event_handler/index.md) and [Bootstrap](https://vadikko2.github.io/python-cqrs-mkdocs/bootstrap/index.md) is required. This integration shows how to consume events from message brokers.

Related Topics

- [Event Producing](https://vadikko2.github.io/python-cqrs-mkdocs/event_producing/index.md) — For publishing events to message brokers
- [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md) — For Protobuf serialization/deserialization
...
For Protobuf event handling, see the [Protobuf Integration](https://vadikko2.github.io/python-cqrs-mkdocs/protobuf/index.md) documentation.
