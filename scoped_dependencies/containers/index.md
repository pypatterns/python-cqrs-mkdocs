...
See [`examples/di/scoped_dependencies_di.py`](https://github.com/vadikko2/python-cqrs/blob/master/examples/di/scoped_dependencies_di.py). SQLAlchemy + outbox: [Tutorial](https://vadikko2.github.io/python-cqrs-mkdocs/scoped_dependencies/tutorial/index.md).
